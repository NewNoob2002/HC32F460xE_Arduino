...
void lv_update_radio_mode_text(int mode_flag)
{
	...
	{
		if (workstatus == 2)
			lv_label_set_text(label_radio_mode_t, "Mode: Receive");
		else if (workstatus == 4)
			lv_label_set_text(label_radio_mode_t, "Mode: Transmit");
		else if (workstatus == 5)
			lv_label_set_text(label_radio_mode_t, "Mode: Bridge");
	}
	else
...
void lv_update_radio_protocol_text(int protocol_flag)
{
	...
	if (protocol_flag)
	{
		if (systemInfo.radioInfo.radio_protocol == 1)
			lv_label_set_text_fmt(label_radio_protocol_t, "Protocol:TRIMTALK");
		else if (systemInfo.radioInfo.radio_protocol == 2)
			lv_label_set_text_fmt(label_radio_protocol_t, "Protocol:TRIMMK3");
		else if (systemInfo.radioInfo.radio_protocol == 4)
			lv_label_set_text_fmt(label_radio_protocol_t, "Protocol:TT450S");
		else if (systemInfo.radioInfo.radio_protocol == 5)
			lv_label_set_text_fmt(label_radio_protocol_t, "Protocol:TRANSEOT");
		else if (systemInfo.radioInfo.radio_protocol == 9)
			lv_label_set_text_fmt(label_radio_protocol_t, "Protocol:SOUTH");
		else if (systemInfo.radioInfo.radio_protocol == 10)
			lv_label_set_text_fmt(label_radio_protocol_t, "Protocol:HUACE");
		else if (systemInfo.radioInfo.radio_protocol == 13)
			lv_label_set_text_fmt(label_radio_protocol_t, "Protocol:SATEL");
		else if (systemInfo.radioInfo.radio_protocol == 16)
			lv_label_set_text_fmt(label_radio_protocol_t, "Protocol:CCS");
		else
			lv_label_set_text_fmt(label_radio_protocol_t, "Protocol:");
	}
	else
...
void lv_update_radio_chanel_text(int chanel_flag)
{
	...
	if (chanel_flag)
	{
		lv_label_set_text_fmt(label_radio_channel_t, "Channel: %d", systemInfo.radioInfo.radio_channel);
	}
	else{
...
void lv_update_ntrip_text(int show_flag)
{
	if (show_flag)
	{
		...
		if (workstatus == 1)
		{
		lv_label_set_text_fmt(screen2_ntripText, "Ntrip Client");
		}
		else if (workstatus == 3)
		{
		lv_label_set_text_fmt(screen2_ntripText, "Ntrip Server");
		}
	}
	else
	{
