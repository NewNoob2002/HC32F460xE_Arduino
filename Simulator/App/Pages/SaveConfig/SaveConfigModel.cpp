...
void
SaveConfigModel::SetStatusBarAppear(const bool delay) const {
...
void
SaveConfigModel::SetStatusBarDisappear(const bool delay) const {
    DataProc::StatusBar_Info_t info;
    DATA_PROC_INIT_STRUCT(info);
    info.cmd = DataProc::STATUS_BAR_CMD_APPEAR;
