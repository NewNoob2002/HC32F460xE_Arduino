...
void
HardwareCheckModel::SetStatusBarAppear(const bool en) const {
...
void
HardwareCheckModel::SetStatusBarStyle(const DataProc::StatusBar_Style_t style) const {
    DataProc::StatusBar_Info_t info;
    DATA_PROC_INIT_STRUCT(info);
