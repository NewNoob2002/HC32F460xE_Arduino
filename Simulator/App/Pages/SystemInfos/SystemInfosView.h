...
class SystemInfosView {
  public:
    ...
    void SetWork(WorkMode_t workMode, RadioInfo_t radioInfo, const NtripInfo_t& ntripInfo) const;

    void SetGPS(double lat, double lng, double alt) const;
    ...
    void SetSystem(const char* firmVer, const char* bootTime, const uint16_t error, const char* buildTime) const;
