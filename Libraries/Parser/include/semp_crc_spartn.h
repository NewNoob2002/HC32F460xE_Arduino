...
static inline uint8_t semp_uSpartnCrc4(const uint8_t *pU8Msg, int size)
{
...
static inline uint8_t semp_uSpartnCrc8(const uint8_t *pU8Msg, int size)
{
    // Initialize local variables
    uint8_t u8TableRemainder;
    uint8_t u8Remainder = 0; // Initial remainder
...
static inline uint16_t semp_uSpartnCrc16(const uint8_t *pU8Msg, int size)
{
    // Initialize local variables
...
static inline uint32_t semp_uSpartnCrc24(const uint8_t *pU8Msg, int size)
{
    // Initialize local variables
...
static inline uint32_t semp_uSpartnCrc32(const uint8_t *pU8Msg, int size)
{
    // Initialize local variables
    uint32_t u32TableRemainder;
