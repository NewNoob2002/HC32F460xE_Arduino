...
class RingBuffer {
  public:
     ...
     */
    bool
    push(TElement element, bool force = false) {
        bool dummy;
     ...
     */
    bool
    push(TElement element, bool force, bool& didOverrun) {
     ...
     */
    bool
    _update_write_index(size_t writtenCount) {
        // update write index
