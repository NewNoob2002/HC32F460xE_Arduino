...
size_t
Print::print(const __FlashStringHelper* ifsh) {
...
size_t
Print::println(const __FlashStringHelper* ifsh) {
    size_t n = print(ifsh);
    n += println();
    return n;
}
...
size_t
Print::println(int num, int base) {
...
size_t
Print::println(unsigned int num, int base) {
    size_t n = print(num, base);
    n += println();
    return n;
}
...
size_t
Print::println(long num, int base) {
    size_t n = print(num, base);
    n += println();
    return n;
}
...
size_t
Print::println(unsigned long num, int base) {
    size_t n = print(num, base);
    n += println();
    return n;
}
...
size_t
Print::println(double num, int digits) {
