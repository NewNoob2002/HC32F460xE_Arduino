...
message_decode(SEMP_PARSE_STATE* parse, uint8_t* txBuffer) {
    ...
    switch (messageId) {
        case NM_PANNEL_INFO_ID: {
            ...
            const uint32_t crc =
                calculate_crc((const char*)msg, (NM_PROTOCOL_PINFO_MSG_PACK_LEN - NM_PROTOCOL_CRC_LEN));
        ...
        case NM_PANNEL_CTRL_ID: {
            ...
            const uint32_t crc =
                calculate_crc((const char*)msg, (NM_PROTOCOL_PCTRL_MSG_PACK_LEN - NM_PROTOCOL_CRC_LEN));
        ...
        case NM_PANNEL_RST_ID: {
            ...
            const uint32_t crc =
                calculate_crc((const char*)msg, (NM_PROTOCOL_RST_RESP_MSG_PACK_LEN - NM_PROTOCOL_CRC_LEN));
        ...
        case NM_PANNEL_POWER_ID: {
            ...
            const uint32_t crc =
                calculate_crc((const char*)msg, (NM_PROTOCOL_POWER_RESP_MSG_PACK_LEN - NM_PROTOCOL_CRC_LEN));
